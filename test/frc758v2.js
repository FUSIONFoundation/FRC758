...
describe("FRC758", function () {
  ...
  it("0-10 10-15 15-20 20-25", async function () {
    ...
    await frc758.mint(owner.address, amount4, now + 20, now + 25);
    ...
    expect(await frc758.balanceOf(owner.address, now, now + 25)).to.equal(10);
    ...
    expect(await frc758.balanceOf(owner.address, now + 10, now + 25)).to.equal(20);
    expect(await frc758.balanceOf(owner.address, now + 15, now + 20)).to.equal(30);
    expect(await frc758.balanceOf(owner.address, now + 15, now + 25)).to.equal(30);
    expect(await frc758.balanceOf(owner.address, now + 20, now + 25)).to.equal(40);
  });
  ...
  it("0-10 12-15 17-20 19-25", async function () {
    ...
    await frc758.mint(owner.address, amount3, now + 17, now + 20);
    await frc758.mint(owner.address, amount4, now + 19, now + 25);
    expect(await frc758.balanceOf(owner.address, now, now + 10)).to.equal(10);
    ...
    expect(await frc758.balanceOf(owner.address, now, now + 19)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now, now + 20)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now, now + 25)).to.equal(0);
    ...
    expect(await frc758.balanceOf(owner.address, now + 10, now + 19)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 10, now + 20)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 10, now + 25)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 12, now + 15)).to.equal(20);
    expect(await frc758.balanceOf(owner.address, now + 12, now + 17)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 12, now + 19)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 12, now + 20)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 12, now + 25)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 15, now + 17)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 15, now + 19)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 15, now + 20)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 15, now + 25)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now + 17, now + 19)).to.equal(30);
    expect(await frc758.balanceOf(owner.address, now + 17, now + 20)).to.equal(30);
    expect(await frc758.balanceOf(owner.address, now + 17, now + 25)).to.equal(30);
    expect(await frc758.balanceOf(owner.address, now + 19, now + 20)).to.equal(70);
    expect(await frc758.balanceOf(owner.address, now + 19, now + 25)).to.equal(40);
    expect(await frc758.balanceOf(owner.address, now + 20, now + 25)).to.equal(40);
  });
  ...
  it("0-10 12-15 17-20 19-20", async function () {
    ...
    await frc758.mint(owner.address, amount2, now + 12, now + 15);
    await frc758.mint(owner.address, amount3, now + 17, now + 20);
    await frc758.mint(owner.address, amount4, now + 19, now + 20);
    expect(await frc758.balanceOf(owner.address, now, now + 10)).to.equal(10);
    expect(await frc758.balanceOf(owner.address, now, now + 15)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now, now + 17)).to.equal(0);
    expect(await frc758.balanceOf(owner.address, now, now + 19)).to.equal(0);
