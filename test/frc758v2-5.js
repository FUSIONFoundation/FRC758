...
describe("safeTransferFrom", function () {
  ...
  it("transferFrom ", async function () {
    ...
    expect(await frc758.timeBalanceOf(owner.address, now + 99, '18446744073709551615')).to.equal(0);
    expect(await frc758.timeBalanceOf(owner.address, now + 100, '18446744073709551615')).to.equal(2);


    await frc758.timeSliceTransferFrom(owner.address, other.address, 1, now + 99, '18446744073709551615'); //sub 0-100
